// Shared config for the escrow CLI: networks, artifacts, signer, helpers.
...
// A jobId can be any 32-byte value; from a human label we derive keccak256(label).
export function toRef(label) {
