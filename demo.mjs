...
console.log('\x1b[1m Pharos Trust-First Agent Suite — live demo (13 skills, 236 tests, CI green)\x1b[0m');
...
const VALREG = '0xd3F1DEf0c294405Cbd02b8b84D1De861A8C058DC';
...
const GATE = '0x425d3F086D8e98B7462cc987ED9B1aF9F396608d';
const GOOD_PROVIDER = '0x6d42BF50c05aC99a5Ef3b85783B8DE75e32cb630';
step('6f. reputation-gate — composite trust gate (reputation 10 + validation 95 → TRUSTED)', '11-reputation-gate',
  `node scripts/gate.mjs check --gate ${GATE} --provider ${GOOD_PROVIDER} --min-reputation 10 --data ${ESCROW_JOB} --min-validation 90`);

const BOND = '0xC59113F22BE46624D8ceFC4A030bCC098a8953Af';
const BONDED_AGENT = '0x39D2bae5EAedA9283535dDC98F1991c81eD5Cd7E';
step('6g. agent-bond — sybil resistance: a bonded agent has skin in the game (read)', '13-agent-bond',
  `node scripts/bond.mjs check --bond ${BOND} --agent ${BONDED_AGENT} --min 0.0001`);
